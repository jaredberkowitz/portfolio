                    ...
                    <br />
                        ...
                        <ul className="col-md-6 mt-5 ">
                                ...
                                <li className="d-flex align-items-center mt-5" >
                                    <div className="box col-md-4 col-sm-4"><Button variant="success" size="xl" active className="btn" style={{fontSize: '24px'}}>Download Resume</Button></div>
