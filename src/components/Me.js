                    ...
                    <br />
                        ...
                        <ul className="col-md-6 col-sm-4  mt-5 ">
                                ...
                                <li className="d-flex align-items-center mt-5" >
                                    <div className="box col-6 col-sm-6"><Button variant="success" size="xl" active className="btn" style={{fontSize: '18px'}}>Download CV</Button></div>
                                    <div className="box col-6 col-sm-4 ml-5"><Button variant="success" size="xl" active className="btn" style={{fontSize: '24px'}}>Contact</Button></div>
                                </li>
                        </ul>  
