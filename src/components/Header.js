  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/jaredberkowitz" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <Nav activeKey="/home" fill className="align-items-right" style={{ position: 'absolute', top: 10, right: 10 }}>
